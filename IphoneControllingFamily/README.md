...
- Example: `com.yourname.iphonecontrollingfamily`
...
- **InitialData.json**: Core functionality
- **FamilyMember.swift**: Core functionality
- **GuardianViewModel.swift**: Custom view component
- **DashboardView.swift**: Custom view component
- **MemberDetailView.swift**: Custom view component
- **RequestCarousel.swift**: Core functionality
